...
const AuthForm = ({ onSubmit, isAdmin }) => {
  const [inputs, setInputs] = useState({
    name: "", email: "", password: "", age: "", phoneNumber: "", gender: ""
  });
        ...
        <Box padding={6} display={"flex"} justifyContent={"center"} flexDirection="column" width={400} margin="auto" alignContent={"center"}>
          ...
          {!isAdmin && isSignup && (
            <>
              ...
              <TextField value={inputs.age} onChange={handleChange} margin="normal" variant="standard" type={"number"} name="age" />
            </>
          )}
          ...
          {!isAdmin && isSignup && (
            <>
              ...
              <TextField value={inputs.gender} onChange={handleChange} margin="normal" variant="standard" type={"text"} name="gender" />
            </>
          )}
          ...
          {!isAdmin && isSignup && (
            <>
              ...
              <TextField value={inputs.phoneNumber} onChange={handleChange} margin="normal" variant="standard" type={"number"} name="phoneNumber" />
            </>
          )}
